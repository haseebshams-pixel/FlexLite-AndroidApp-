                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            dao = new FirebaseDAO(new FirebaseDAO.DataObserver() {
                                @Override
                                public void update() {
                                    Teacher tch = Teacher.load(dao, id);
                                    if (tch != null) {
                                        updateUI(user);
                                    } else {
                                        mAuth.signOut();
                                        Toast.makeText(TeacherLoginActivity.this, "User not found", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }, "teacher");
                            ...
                            Toast.makeText(TeacherLoginActivity.this, "incorrect Credentials",
